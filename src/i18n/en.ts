const en = {
  ...
  about: {
    ...
    counters: {
      ...
      projects: 'Designs Delivered',
      brands: 'Brands Developed',
    },
  },
  services: {
  title: 'Services',
...
portfolio: {
  items: [
    ...
    {
      title: 'Navah Consulting & Business',
      category: 'Branding',
    },
    {
      title: 'Traluz - Solar Energy',
      category: 'Visual Identity',
    },
    {
      title: 'Paulo Vieira Business Growth Tour',
      category: 'Graphic Material',
    },
    {
      title: 'Vertta Dentistry',
      category: 'Mockup',
    },
  ],
},
...
contact: {
  ...
  whatsappMessage: {
    ...
    interest: 'I am interested in a quote with the following details:',
    name: '► Name:',
    email: '► Email:',
    service: '► Service:',
    message: '► Message:',
