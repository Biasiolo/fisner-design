const pt = {
  ...
  about: {
    ...
    counters: {
      ...
      projects: 'Artes Entregues',
      brands: 'Marcas Desenvolvidas',
    },
  },
  services: {
  title: 'Serviços',
...
contact: {
 ...
 download: 'Baixar Currículo',
  ...
  whatsappMessage: {
    greeting: 'Olá Gustavo!',
    interest: 'Tenho interesse em um orçamento com os seguintes dados:',
    name: '► Nome:',
    email: '► Email:',
    service: '► Serviço:',
    message: '► Mensagem:',
